...
| `quartus/timing_split.txt` | **STA by path class** — reg-to-reg+input **+2.4 ns MET**; combinational Avalon output pins **−2.86 ns** (pad-buffer-limited standalone, OOC artifact) | (derived) |
| `quartus/i3c_target.flow.rpt` | Full compile-flow report | (Quartus) |

> Timing: the **internal logic meets 125 MHz** (reg-to-reg + input paths, +2.4 ns). The
